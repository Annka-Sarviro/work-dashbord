        ...
        <DayPicker
            ...
            classNames={{
                ...
                button_previous: cn(
                    ...
                    'h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 absolute left-1 top-2.5'
                ),
                button_next: cn(
                    buttonVariants({ variant: 'outline' }),
                    'h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 absolute right-1 top-2.5'
                ),
